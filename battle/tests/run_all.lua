...
harness.run({
    ...
    require("battle.tests.test_runtime_rule_authority"),
    require("battle.tests.test_authority_facades"),
    require("battle.tests.test_marble_setup_authority"),
    ...
    require("battle.tests.test_numeric_safety"),
