...
M.behaviour = {
    inert = { family = "basic", label = "BASE", sigil = "centre_dot" },
    absorb = { family = "defensive", label = "ABS", sigil = "inward_brackets" },
    reflect = { family = "defensive", label = "REF", sigil = "opposed_chevrons" },
    regenerate = { family = "defensive", label = "REG", sigil = "broken_ring_leaf" },
    fortify = { family = "defensive", label = "FORT", sigil = "three_block_wall" },
    poison = { family = "effect", label = "PSN", sigil = "droplet_dot" },
    freeze = { family = "effect", label = "FRZ", sigil = "six_spoke_flake" },
    magnetic = { family = "effect", label = "MAG", sigil = "horseshoe" },
    shatter = { family = "effect", label = "SHT", sigil = "broken_diamond" },
    chain = { family = "utility", label = "CHN", sigil = "linked_ovals" },
    vault = { family = "utility", label = "VLT", sigil = "stone_arch" },
    splice = { family = "utility", label = "SPL", sigil = "branch_y" },
    dummy = { family = "utility", label = "DMY", sigil = "crosshair_x" },
    aegis = { family = "rare", label = "AEG", sigil = "pointed_shield" },
    void = { family = "rare", label = "VOID", sigil = "hollow_disc" },
    mirror = { family = "rare", label = "MIR", sigil = "split_vertical" },
    temporal = { family = "rare", label = "TMP", sigil = "hourglass" },
}
