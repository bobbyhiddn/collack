...
WEB_MANIFEST_SHA256="$(shasum -a 256 "$ROOT/dist/web/callack-build-manifest.json" | awk '{print $1}')"
WEB_ASSET_SET_SHA256="$(node -p "require('$ROOT/dist/web/callack-build-manifest.json').assetSetSha256")"
WEB_SOURCE_SET_SHA256="$(node -p "require('$ROOT/dist/web/callack-build-manifest.json').sourceSetSha256")"
...
schema=callack-ios-simulator-smoke-v2
source_commit=$SOURCE_COMMIT
source_tree=$SOURCE_TREE
runtime_target=web
runtime_path=src
runtime_output=dist/web
build_recipe=scripts/build-web.sh
web_manifest_sha256=$WEB_MANIFEST_SHA256
web_asset_set_sha256=$WEB_ASSET_SET_SHA256
web_source_set_sha256=$WEB_SOURCE_SET_SHA256
